package find.intersection.point.in.linkedlist;
...
public class LinkedListIntersection {
	...
	public static void main(String[] args) {
		...
		list.head1.next.next = new Node(25);
		...
		System.out.println("The node of intersection is " + list.getIntersectedNode());
	...
	int _getIntesectionNode(int d, Node node1, Node node2) {
		...
		while (current1 != null && current2 != null) {
			System.out.println("equals current1 :" + current1.data);
			System.out.println("equals current2:" + current2.data);
